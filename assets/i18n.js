...
(function () {
  ...
  var STRINGS = {
    ...
    "gym.emptyHelp": ["Log it in the Gym Sessions database in Notion: Date, Type A/B/C, Duration and RPE. The chart fills in after the nightly sync.", "在 Notion「Gym Sessions」資料庫記錄：日期、類型 A/B/C、時長同 RPE。每晚同步後圖表就會更新。"],
    ...
    "food.emptyHelp": ["Log one row a day in the Meals database in Notion: Calories, Protein g, Water and the On target checkbox. Thirty seconds a day is enough.", "在 Notion「Meals」資料庫每日記一列：卡路里、蛋白質（g）、飲水量同「On target」。每日三十秒就夠。"],
